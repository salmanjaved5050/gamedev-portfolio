<template>
  <div>
    ...
    <div class="photo">
      <img src="img/resume-photo.png" alt="Photo of Salman" />
    </div>
    ...
    <div class="full-content">
      ...
      <div class="work-entry">
        <h3>English</h3>
        <div>Fluent and professional level.</div>
      </div>

      <h2><i class="fa-solid fa-heart"></i> Besides...</h2>
      ...
      <div class="interests-grid">
        ...
        <div class="interest-card">
          ...
          <div>I used to stay at home a lot but then got hooked to travelling once I visited Thailand and Malaysia,
            amazing places and hoping to travel way more :)</div>
        </div>

        <div class="interest-card">
          <h3>I 💛 Horror</h3>
          <div>A huge fan of horror movies and novels to the bone. Read R.L. Stine all my teenage and always show up at
...
.photo img {
  ...
  box-shadow: 0 4px 24px rgba(124, 111, 255, 0.2);
}
...
.skill {
  ...
  font-weight: 600;
  font-size: 0.85em;
  background: linear-gradient(135deg, rgba(124, 111, 255, 0.15), rgba(255, 107, 107, 0.1));
